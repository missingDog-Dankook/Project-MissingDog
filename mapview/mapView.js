  ...
  function initMap() {
    if (mapVal === '용인시 동물보호센터') {
      ...
      var infoWindow = new google.maps.InfoWindow({
        content:
          '<a href = "../infoview/gyeonggi_yongin/infoView_yongin.html"><h1>용인시 동물보호센터</h1></a>' +
          '<br>' +
      ...
      var infoWindow = new google.maps.InfoWindow({
        content:
          '<a href = "../infoview/seoul_songpa/infoView_songpa.html"><h1>한국동물구조관리협회</h1></a>' +
          '<br>' +
      ...
      var infoWindow = new google.maps.InfoWindow({
        content:
          '<a href = "../infoview/seoul_seocho/infoView_seocho.html"><h1>서초동물사랑센터</h1></a>' +
          '<br>' +
      ...
      var infoWindow = new google.maps.InfoWindow({
        content:
          '<a href = "../infoview/gyeonggi_seongnam/infoView_seongnam.html"><h1>펫토피아 동물병원</h1></a>' +
          '<br>' +
      ...
      var infoWindow = new google.maps.InfoWindow({
        content:
          '<a href = "../infoview/gyeonggi_hanam/infoView_hanam.html"><h1>하남 동물병원</h1></a>' +
          '<br>' +
      ...
      var infoWindow = new google.maps.InfoWindow({
        content:
          '<a href = "../infoview/gyeonggi_pyeongtaek/infoView_pyeongtaek.html"><h1>평택시 유기동물 보호소</h1></a>' +
          '<br>' +
      ...
      var infoWindow = new google.maps.InfoWindow({
        content:
          '<a href = "../infoview/chungbuk_chungju/infoView_chungju.html"><h1>충주시 동물보호센터</h1></a>' +
          '<br>' +
      ...
      var infoWindow = new google.maps.InfoWindow({
        content:
          '<a href = "../infoview/chungnam_seosan/infoView_seosan.html"><h1>서산시 동물보호센터</h1></a>' +
          '<br>' +
      ...
      var infoWindow = new google.maps.InfoWindow({
        content:
          '<a href = "../infoview/gangwon/infoView_gangwon.html"><h1>평창군 유기동물보호소</h1></a>' +
          '<br>' +
      ...
      var infoWindow = new google.maps.InfoWindow({
        content:
          '<a href = "../infoview/gangwon/infoView_gangwon.html"><h1>정선 가축병원</h1></a>' +
          '<br>' +
      ...
      var infoWindow = new google.maps.InfoWindow({
        content:
          '<a href = "../infoview/gangwon/infoView_gangwon.html"><h1>철원군 유기견보호소</h1></a>' +
          '<br>' +
      ...
      var infoWindow = new google.maps.InfoWindow({
        content:
          '<a href = "../infoview/jeolbuk_gunsan/infoView_gunsan.html"><h1>군산 유기동물보호센터</h1></a>' +
          '<br>' +
      ...
      var infoWindow = new google.maps.InfoWindow({
        content:
          '<a href = "../infoview/jeolnam_gangjin/infoView_gangjin.html"><h1>강진군 유기견 보호소</h1></a>' +
          '<br>' +
      ...
      var infoWindow = new google.maps.InfoWindow({
        content:
          '<a href = "../infoview/daegu_dalseo/infoView_daegu.html"><h1>대구 유기동물보호센터</h1></a>' +
          '<br>' +
